## Simple Shell
> In this project, coded from scratch a simple Unix shell. A shell is an interactive
> command-line interpreter. created a shell that would utilize the command line
> 
...
### Synopsis
> This repository holds all the code necessary for the custom simple shell to run.
> The shell currently handles the executions of executables found in the
